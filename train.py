...
valid_data = load_labelled_patches(["SU4211"], patch_size, limit=1000)
...
# Fit the model
model.fit_generator(train_data, samples_per_epoch=64000, nb_epoch=10, validation_data=valid_data, nb_val_samples=3200, verbose=1)
